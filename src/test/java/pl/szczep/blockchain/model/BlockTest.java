...
public class BlockTest {
    ...
    public void shouldChangeHashForDifferentTimeCreations() throws InterruptedException {
        final Block block1 = Block.builder().metaData("Hello Blockchain").previousHash("").build();
        TimeUnit.SECONDS.sleep(1);
        final Block block2 = Block.builder().metaData("Hello Blockchain").previousHash("").build();
    ...
    public void shouldChangeHashWhenDataChanged() {
        ...
        block.setMetaData("Hello Blockchain!");
